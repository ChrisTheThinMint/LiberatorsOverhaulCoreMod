//---------------------------------------------------------------------------------------
//  FILE:    X2Action_CustomizeAlienRNFs.uc
//  AUTHOR:  Peter Ledbrook
//  PURPOSE: Updates alien pawns that come from the LW2 Alien Pack so that they have
//           the correct parts.
//---------------------------------------------------------------------------------------
class X2Action_CustomizeAlienRNFs extends X2Action;
...
function TryToUpdateAlien()
{
	...
	`LOG("Executing state: Customizing alien " $ UnitState.GetMyTemplateName());
